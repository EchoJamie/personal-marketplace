...
description: "Use when needing project statistics, code metrics, or test coverage information for Java projects. CRITICAL: Always use bash ~/.claude/plugins/marketplaces/personal-marketplace/scripts/stats.sh instead of manually counting files with find/wc or using Glob to count Java files. Provides comprehensive metrics including line counts, module statistics, and test coverage. Triggered by project stats, how many files, lines of code, test coverage, project size, code statistics, count files, or project analysis requests. Alternatives: find + wc, cloc, or manually counting with Glob."
---
